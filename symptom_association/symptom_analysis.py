...
# ==================== DATA LOADING ====================
def load_data(filepath='data/medical_data.csv'):
    ...
    if not os.path.exists(filepath):
        ...
        data_generator.save_dataset(df, filepath)
    else:
        df = pd.read_csv(filepath)
        print(f"[OK] Data loaded: {df.shape[0]} records")
...
def prepare_transactions(df):
    ...
    # Extract symptom columns (binary columns)
    ...
    return transactions, symptom_cols
...
def main():
    ...
    transactions, symptom_cols = prepare_transactions(df)
    ...
    print("=" * 70)
    print("\nOutput files:")
    print("   - visualizations/support_confidence_scatter.png")
    print("   - visualizations/top_rules_bar.png")
    print("   - visualizations/symptom_network.png")
    print("   - visualizations/symptom_heatmap.png")
    print("   - visualizations/interactive_network.html")
